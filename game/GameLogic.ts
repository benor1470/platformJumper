...
class GameLogic {
    ...
    move(timePassed: number) {
        ...
        Values.score += Values.scoreGainPerSec * timePassed;
        ...
        //pickups
        if (this.pickups.length < 2) {//2 && Math.random()>0.9){
...
class Board {
    ...
    constructor() {
        ...
        this.rotationSpeed = Math.random() * Values.boardRotateSpeedRange - Values.boardRotateSpeedRange / 0.05;//2000;//-Math.PI/100;
